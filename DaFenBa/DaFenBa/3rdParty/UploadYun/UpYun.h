 ...
 */
// http://dfb2014.b0.upaiyun.com/
#define DEFAULT_BUCKET @"dfb2014"
#define DEFAULT_UPYUN_PREFIX @"http://"DEFAULT_BUCKET@".b0.upaiyun.com/"
/**
 *	@brief	默认表单API功能密钥 （必填项），可在init之后修改passcode的值来更改
 */
#define DEFAULT_PASSCODE @"cg02zwV+8aXm1Lymd9dsQw6DzM0="
...
+(NSString * )getSaveKey:(NSString *)directory ;
@end
