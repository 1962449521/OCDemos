...
- (NSString *)timeAgo
{
    ...
    if(deltaSeconds < 5)
    {
        return NSDateTimeAgoLocalizedStrings(@"刚刚");
    }
    ...
    {
        return [self stringFromFormat:@"%%d %@m分钟前" withValue:deltaMinutes];
    }
    ...
    {
        return NSDateTimeAgoLocalizedStrings(@"昨天");
    }
    else if (deltaMinutes < (24 * 60 * 7))
    {
    ...
    {
        return NSDateTimeAgoLocalizedStrings(@"上周");
    }
    else if (deltaMinutes < (24 * 60 * 31))
    {
    ...
    {
        return NSDateTimeAgoLocalizedStrings(@"上月");
    }
    else if (deltaMinutes < (24 * 60 * 365.25))
    {
    ...
    return [self stringFromFormat:@"第一发哦" withValue:minutes];
}
...
- (NSString *)dateTimeAgo
{
    ...
    if (components.year >= 1)
    {
        if (components.year == 1)
        {
            return NSDateTimeAgoLocalizedStrings(@"1 年前");
        }
    ...
    else if (components.month >= 1)
    {
        ...
        {
            return NSDateTimeAgoLocalizedStrings(@"1 月前");
        }
    ...
    else if (components.week >= 1)
    {
        ...
        {
            return NSDateTimeAgoLocalizedStrings(@"1 周前");
        }
    ...
    else if (components.day >= 1)    // up to 6 days ago
    {
        if (components.day == 1)
        {
            return NSDateTimeAgoLocalizedStrings(@"1 天前");
        }
    ...
    else if (components.hour >= 1)   // up to 23 hours ago
    {
        ...
        {
            return NSDateTimeAgoLocalizedStrings(@"1 小时前");
        }
        return [self stringFromFormat:@"%%d %@小时前" withValue:components.hour];
    }
    else if (components.minute >= 1) // up to 59 minutes ago
    {
        if (components.minute == 1)
        {
            return NSDateTimeAgoLocalizedStrings(@"1 分钟前");
        }
...
- (NSString *)dateTimeUntilNow
{
    ...
    if (components.hour >= 6) // if more than 6 hours ago, change precision
    {
        ...
        else
        {
            ...
            if (diffWeeks == 0)
            {
                return NSDateTimeAgoLocalizedStrings(@"这周");
            }
            else if (diffWeeks == 1)
            {
                return NSDateTimeAgoLocalizedStrings(@"上周");
            ...
            else
            {
                ...
                if (diffMonths == 0)
                {
                    return NSDateTimeAgoLocalizedStrings(@"本月");
                }
                ...
                else
                {
                    ...
                    if (diffYears == 0)
                    {
                        return NSDateTimeAgoLocalizedStrings(@"今年");
                    }
                    else if (diffYears == 1)
                    {
                        return NSDateTimeAgoLocalizedStrings(@"去年");
