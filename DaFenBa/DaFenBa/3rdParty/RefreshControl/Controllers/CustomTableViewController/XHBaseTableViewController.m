...
- (void)loadDataSource {
    // subClasse
    if ([self.tableView.dataSource respondsToSelector:@selector(loadDataSource)])
        [self.tableView.dataSource performSelector:@selector(loadDataSource) withObject:nil];
}
