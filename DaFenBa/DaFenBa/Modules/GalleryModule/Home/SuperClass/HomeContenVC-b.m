...
/*{
    ...
    if (!loadMoreView) {
        ...
        [loadMoreView setTop:DEVICE_screenHeight - 64 - 44 - loadMoreView.height];
    }
    ...
    if (newOffsetY > oldOffsetY + 60 ) {
        ...
        if (homeVC.tabBarController.tabBar.hidden == YES) {
            return;
        }

        [UIView animateWithDuration:0.3 animations:^{
            [homeVC.tabBarController.tabBar setTop:DEVICE_screenHeight];
        ...
        homeVC.slideSwitchView.height = DEVICE_screenHeight - 20 - 44;
        
    }
    else if(newOffsetY < oldOffsetY - 60  ) {
        //向下
        oldOffsetY = newOffsetY;
        if (homeVC.tabBarController.tabBar.hidden == NO)
        {
            return;
        }
        [UIView animateWithDuration:0.3 animations:^{
            [homeVC.tabBarController.tabBar setTop:DEVICE_screenHeight- 49];
